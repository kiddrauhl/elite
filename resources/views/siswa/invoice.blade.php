...
<head>
    ...
    <style>
        ...
        .status-stamp { display: inline-block; padding: 10px 25px; background-color: #ecfdf5; color: #059669; border: 3px solid #059669; font-size: 20px; font-weight: 900; text-transform: uppercase; border-radius: 8px; transform: rotate(-15deg); margin-top: 20px; margin-left: 30px; opacity: 0.8; }
...
<body>
    <div class="invoice-box">
            ...
            <tr>
                <td width="60%">
                    ...
                    <div class="client-details">
                        <strong>{{ $siswa->nama_siswa ?? ($siswa->nama_lengkap ?? 'Siswa Elite') }}</strong><br>
                        Level Kelas: {{ $siswa->nama_level ?? '-' }}
                    </div>
                </td>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>
                        <strong>Registrasi Ulang Program Lanjutan</strong><br>
                        <span style="font-size: 11px; color: #666;">Biaya daftar ulang dan akses modul kelas tingkat selanjutnya di Elite Academy.</span>
                    </td>
                    <!-- Pastikan pemanggilan variabel nominal bayar sesuai database Anda (jumlah_bayar atau jumlah_pembayaran) -->
        ...
        <div class="footer">
            ...
            Dokumen ini diterbitkan secara otomatis oleh sistem komputer dan sah sebagai bukti pembayaran resmi tanpa memerlukan tanda tangan basah.<br>
